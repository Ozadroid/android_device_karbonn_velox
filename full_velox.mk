...
DEVICE_PACKAGE_OVERLAYS := device/karbonn/velox/overlay
...
# USB ModeSwitch
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/karbonn/velox/configs/usb_modeswitch.d,system/etc/usb_modeswitch.d)

# Prebuilt kernel modules
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,device/karbonn/velox/modules,system/lib/modules)
...
PRODUCT_PACKAGES += \
    40183/nvram.txt \
    40183/fw_bcm40181b2.bin \
    40183/fw_bcm40181b2_apsta.bin \
    40183/fw_bcm40181b2_p2p.bin \
    wl \
    dhd
...
$(call inherit-product-if-exists, vendor/karbonn/velox/velox-vendor.mk)
